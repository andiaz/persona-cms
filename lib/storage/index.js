...
export function importData(data, options = { merge: false }) {
  ...
  const result = { personas: 0, journeyMaps: 0, impactMaps: 0 };
...
export function getStorageInfo() {
  if (!isBrowser) return { used: 0, personas: 0, journeyMaps: 0, impactMaps: 0 };
  ...
  return {
    used: personasData.length + journeyMapsData.length + impactMapsData.length,
